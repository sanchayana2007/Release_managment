...
module.exports = function(app) 
{
	...
	app.post('/feature', function(req, res) {
	  console.log("DEBUG:/POST/feature:featurenumber Name " + req.body.featurename );
	  console.log("DEBUG:/POST/feature:releasename "+ req.body.releasenumber);
	  console.log("DEBUG:/POST/feature:description "+ req.body.description);
	  console.log("DEBUG:/POST/feature:Feature Number "+ req.body.moduleEffected);
	  console.log("DEBUG:/POST/feature:Archtecture description "+ req.body.architecturedespcription);
	  console.log("DEBUG:/POST/feature:Start Date "+ new Date(req.body.startDate).toDateString());
	  console.log("DEBUG:/POST/feature:Start Date "+ new Date(req.body.endDate).toDateString());
	  var lpost
	  Feature.findOne({}, {}, { sort: { 'featurenumber' : -1 } }, function(err, post) {
	    if(post){
	      lpost = post.featurenumber;
		}
	    console.log( "DEBUG:POST/feature: last old Feature Number" + post  + lpost)
	    if(lpost){
		  lpost = lpost + 1;
	    }else{
		  lpost=1
		...
		if (req.body.featurename){
		  ...
		  var thor = new Feature({
		    featurename: req.body.featurename,
		    featurenumber: lpost,
		    releasenumber: req.body.releasenumber,
		    description: req.body.description,
		    moduleEffected: req.body.moduleEffected,
		    architecturedespcription: req.body.architecturedespcription,
